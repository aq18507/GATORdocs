...
copyright = 'abc' #f'{year}, RMH Aerospace'
author = 'Rafael Heeb'
...
version = '1' #f'beta:{major_version}.{minor_version}'
# The full version, including alpha/beta/rc tags.
release = '1' #f'beta:{major_version}.{minor_version}'
...
html_logo = '../figures/GATOR_logo_v1.png'
